    ...
    >
      {plan ? (
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.04]">
          ...
          <p className="mt-2 text-sm font-semibold text-slate-950 dark:text-white">{plan.duration_minutes} minutos</p>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">{new Date(plan.created_at).toLocaleDateString("es-CO")}</p>
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.04]">
          ...
          <p className="mt-2 text-sm font-semibold text-slate-950 dark:text-white">{plan.topic}</p>
            </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.04]">
              <p className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.16em] text-slate-500">
          ...
          <p className="mt-2 text-sm font-semibold text-slate-950 dark:text-white">{getEvaluationTypeLabel(plan.evaluation_type)}</p>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Estado: {getPlanStatusLabel(plan.status)}</p>
            </div>
          </div>

        <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.04]">
            <p className="text-xs uppercase tracking-[0.16em] text-slate-500">Objetivo</p>
          <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-200">{plan.objective}</p>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.04]">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-200">{plan.resources ?? "Sin recursos definidos"}</p>
          </div>
