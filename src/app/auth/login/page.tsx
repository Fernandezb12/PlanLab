...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-slate-950 px-6 py-10">
      <div className="mx-auto grid max-w-6xl overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/60 shadow-2xl lg:grid-cols-[1.2fr_0.8fr]">
        <section className="relative p-8 md:p-10">
          ...
          <div className="relative z-10">
            <div className="mb-10 flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-bold text-white">PlanLab</p>
                <p className="text-xs text-slate-400">Acceso profesional docente</p>
              </div>
            </div>

            <p className="inline-flex rounded-full border border-brand-500/30 bg-brand-500/10 px-3 py-1 text-xs font-medium text-brand-300">Ingreso rápido</p>
            <h1 className="mt-5 text-4xl font-bold leading-tight text-white md:text-5xl">Bienvenido nuevamente.</h1>
            <p className="mt-4 max-w-xl text-slate-300">Ingresa en segundos para continuar tu planificación, revisar actividades pendientes y mantener el seguimiento pedagógico al día.</p>

            <div className="mt-10 space-y-4">
              {loginHighlights.map((item) => (
                <div key={item.text} className="flex items-center gap-3 rounded-2xl border border-slate-800 bg-slate-950/70 px-4 py-3">
        ...
        <section className="border-t border-slate-800 bg-white p-8 md:p-10 lg:border-l lg:border-t-0 dark:bg-slate-900">
